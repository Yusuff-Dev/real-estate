...
import logoResult from '../assets/icons/logo-result.svg'
function Footer() {
    return (
        <footer>
            <div className='container max-w-[1480px]'>
                <div className='flex items-center justify-between flex-wrap py-[50px] border-b border-stroke'>
                    <Logo />
                ...
                <ul className='flex flex-col gap-1'>
                    ...
                    <li className='content text-black font-Jost'><Link>Оценить</Link></li>
                </ul>
                <ul className='flex flex-col gap-1'>
                    <li className='subtitle-24 text-black font-Jost mb-3'>Недвижимость</li>
                    <li className='content text-black font-Jost'><Link>Квартиры</Link></li>
                    <li className='content text-black font-Jost'><Link>Новостройки</Link></li>
                    <li className='content text-black font-Jost'><Link>Дома и участки</Link></li>
                    <li className='content text-black font-Jost'><Link>Коммерческая</Link></li>
                </ul>
                <ul className='flex flex-col gap-1'>
                    <li className='subtitle-24 text-black font-Jost mb-3'>Компания</li>
                    <li className='content text-black font-Jost'><Link>О нас</Link></li>
                    <li className='content text-black font-Jost'><Link>Блог</Link></li>
                    <li className='content text-black font-Jost'><Link>Контакты</Link></li>
                    <li className='content text-black font-Jost'><Link>Связаться</Link></li>
                </ul>
                <ul className='flex flex-col gap-1'>
                    <li className='subtitle-24 text-black font-Jost mb-3'>Другое</li>
                    <li className='content text-black font-Jost'><Link>Ипотечный калькулятор</Link></li>
                    <li className='content text-black font-Jost'><Link>Инвестиции в недвижимость в Дубае</Link></li>
                </ul>
                </div>

                <div className='py-[10px] flex items-center justify-between border-t border-stroke'>
                    <p className='label text-[#B3B3B3] font-Jost'>2024 © RMC De Luxe real estate LLC. Все права защищены</p>
                    <div>
                        <img src={logoResult} alt="logo result" />
                    </div>
                </div>
            </div>
        </footer>
